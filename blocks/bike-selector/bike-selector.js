export default function decorate(block) {
  ...
  block.querySelectorAll('input[name="variant"]').forEach(v => v.addEventListener('change', updateImage));
  block.querySelectorAll('input[name="color"]').forEach(c => c.addEventListener('change', updateImage));
}
